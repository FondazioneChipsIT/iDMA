...
package idma_reg64_2d_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    idma_reg64_2d_reg2hw_conf_reg_t conf; // [466:450]
    idma_reg64_2d_reg2hw_next_id_mreg_t [1:0] next_id; // [449:384]
  ...
  // HW -> register type
  typedef struct packed {
    idma_reg64_2d_hw2reg_status_mreg_t [1:0] status; // [147:128]
    idma_reg64_2d_hw2reg_next_id_mreg_t [1:0] next_id; // [127:64]
    idma_reg64_2d_hw2reg_done_id_mreg_t [1:0] done_id; // [63:0]
  ...
  parameter logic [BlockAw-1:0] IDMA_REG64_2D_NEXT_ID_0_OFFSET = 8'h c;
  parameter logic [BlockAw-1:0] IDMA_REG64_2D_NEXT_ID_1_OFFSET = 8'h 10;
  parameter logic [BlockAw-1:0] IDMA_REG64_2D_DONE_ID_0_OFFSET = 8'h 14;
  parameter logic [BlockAw-1:0] IDMA_REG64_2D_DONE_ID_1_OFFSET = 8'h 18;
  ...
  // Register width information to check illegal writes
  parameter logic [3:0] IDMA_REG64_2D_PERMIT [19] = '{
    4'b 0111, // index[ 0] IDMA_REG64_2D_CONF
    4'b 0011, // index[ 1] IDMA_REG64_2D_STATUS_0
    4'b 0011, // index[ 2] IDMA_REG64_2D_STATUS_1
    4'b 1111, // index[ 3] IDMA_REG64_2D_NEXT_ID_0
    4'b 1111, // index[ 4] IDMA_REG64_2D_NEXT_ID_1
    4'b 1111, // index[ 5] IDMA_REG64_2D_DONE_ID_0
    4'b 1111, // index[ 6] IDMA_REG64_2D_DONE_ID_1
    4'b 1111, // index[ 7] IDMA_REG64_2D_DST_ADDR_LOW
    4'b 1111, // index[ 8] IDMA_REG64_2D_DST_ADDR_HIGH
    4'b 1111, // index[ 9] IDMA_REG64_2D_SRC_ADDR_LOW
    4'b 1111, // index[10] IDMA_REG64_2D_SRC_ADDR_HIGH
    4'b 1111, // index[11] IDMA_REG64_2D_LENGTH_LOW
    4'b 1111, // index[12] IDMA_REG64_2D_LENGTH_HIGH
    4'b 1111, // index[13] IDMA_REG64_2D_DST_STRIDE_2_LOW
    4'b 1111, // index[14] IDMA_REG64_2D_DST_STRIDE_2_HIGH
    4'b 1111, // index[15] IDMA_REG64_2D_SRC_STRIDE_2_LOW
    4'b 1111, // index[16] IDMA_REG64_2D_SRC_STRIDE_2_HIGH
    4'b 1111, // index[17] IDMA_REG64_2D_REPS_2_LOW
    4'b 1111  // index[18] IDMA_REG64_2D_REPS_2_HIGH
  };
...
package idma_reg64_1d_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    idma_reg64_1d_reg2hw_conf_reg_t conf; // [274:258]
    idma_reg64_1d_reg2hw_next_id_mreg_t [1:0] next_id; // [257:192]
  ...
  // HW -> register type
  typedef struct packed {
    idma_reg64_1d_hw2reg_status_mreg_t [1:0] status; // [147:128]
    idma_reg64_1d_hw2reg_next_id_mreg_t [1:0] next_id; // [127:64]
    idma_reg64_1d_hw2reg_done_id_mreg_t [1:0] done_id; // [63:0]
  ...
  parameter logic [BlockAw-1:0] IDMA_REG64_1D_NEXT_ID_0_OFFSET = 8'h c;
  parameter logic [BlockAw-1:0] IDMA_REG64_1D_NEXT_ID_1_OFFSET = 8'h 10;
  parameter logic [BlockAw-1:0] IDMA_REG64_1D_DONE_ID_0_OFFSET = 8'h 14;
  parameter logic [BlockAw-1:0] IDMA_REG64_1D_DONE_ID_1_OFFSET = 8'h 18;
  ...
  // Register width information to check illegal writes
  parameter logic [3:0] IDMA_REG64_1D_PERMIT [13] = '{
    4'b 0111, // index[ 0] IDMA_REG64_1D_CONF
    4'b 0011, // index[ 1] IDMA_REG64_1D_STATUS_0
    4'b 0011, // index[ 2] IDMA_REG64_1D_STATUS_1
    4'b 1111, // index[ 3] IDMA_REG64_1D_NEXT_ID_0
    4'b 1111, // index[ 4] IDMA_REG64_1D_NEXT_ID_1
    4'b 1111, // index[ 5] IDMA_REG64_1D_DONE_ID_0
    4'b 1111, // index[ 6] IDMA_REG64_1D_DONE_ID_1
    4'b 1111, // index[ 7] IDMA_REG64_1D_DST_ADDR_LOW
    4'b 1111, // index[ 8] IDMA_REG64_1D_DST_ADDR_HIGH
    4'b 1111, // index[ 9] IDMA_REG64_1D_SRC_ADDR_LOW
    4'b 1111, // index[10] IDMA_REG64_1D_SRC_ADDR_HIGH
    4'b 1111, // index[11] IDMA_REG64_1D_LENGTH_LOW
    4'b 1111  // index[12] IDMA_REG64_1D_LENGTH_HIGH
  };
...
module idma_reg64_2d_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[ 3] = (reg_addr == IDMA_REG64_2D_NEXT_ID_0_OFFSET);
    addr_hit[ 4] = (reg_addr == IDMA_REG64_2D_NEXT_ID_1_OFFSET);
    addr_hit[ 5] = (reg_addr == IDMA_REG64_2D_DONE_ID_0_OFFSET);
    addr_hit[ 6] = (reg_addr == IDMA_REG64_2D_DONE_ID_1_OFFSET);
    addr_hit[ 7] = (reg_addr == IDMA_REG64_2D_DST_ADDR_LOW_OFFSET);
    addr_hit[ 8] = (reg_addr == IDMA_REG64_2D_DST_ADDR_HIGH_OFFSET);
    addr_hit[ 9] = (reg_addr == IDMA_REG64_2D_SRC_ADDR_LOW_OFFSET);
    addr_hit[10] = (reg_addr == IDMA_REG64_2D_SRC_ADDR_HIGH_OFFSET);
    addr_hit[11] = (reg_addr == IDMA_REG64_2D_LENGTH_LOW_OFFSET);
    addr_hit[12] = (reg_addr == IDMA_REG64_2D_LENGTH_HIGH_OFFSET);
    addr_hit[13] = (reg_addr == IDMA_REG64_2D_DST_STRIDE_2_LOW_OFFSET);
    addr_hit[14] = (reg_addr == IDMA_REG64_2D_DST_STRIDE_2_HIGH_OFFSET);
    addr_hit[15] = (reg_addr == IDMA_REG64_2D_SRC_STRIDE_2_LOW_OFFSET);
    addr_hit[16] = (reg_addr == IDMA_REG64_2D_SRC_STRIDE_2_HIGH_OFFSET);
    addr_hit[17] = (reg_addr == IDMA_REG64_2D_REPS_2_LOW_OFFSET);
    addr_hit[18] = (reg_addr == IDMA_REG64_2D_REPS_2_HIGH_OFFSET);
  end
  ...
  assign dst_addr_high_we = addr_hit[8] & reg_we & !reg_error;
  assign dst_addr_high_wd = reg_wdata[31:0];

  assign src_addr_low_we = addr_hit[9] & reg_we & !reg_error;
  assign src_addr_low_wd = reg_wdata[31:0];

  assign src_addr_high_we = addr_hit[10] & reg_we & !reg_error;
  ...
  assign dst_stride_2_low_we = addr_hit[13] & reg_we & !reg_error;
  assign dst_stride_2_low_wd = reg_wdata[31:0];

  assign dst_stride_2_high_we = addr_hit[14] & reg_we & !reg_error;
  assign dst_stride_2_high_wd = reg_wdata[31:0];

  assign src_stride_2_low_we = addr_hit[15] & reg_we & !reg_error;
  assign src_stride_2_low_wd = reg_wdata[31:0];

  assign src_stride_2_high_we = addr_hit[16] & reg_we & !reg_error;
  assign src_stride_2_high_wd = reg_wdata[31:0];

  assign reps_2_low_we = addr_hit[17] & reg_we & !reg_error;
  assign reps_2_low_wd = reg_wdata[31:0];

  assign reps_2_high_we = addr_hit[18] & reg_we & !reg_error;
...
module idma_reg64_1d_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[ 3] = (reg_addr == IDMA_REG64_1D_NEXT_ID_0_OFFSET);
    addr_hit[ 4] = (reg_addr == IDMA_REG64_1D_NEXT_ID_1_OFFSET);
    addr_hit[ 5] = (reg_addr == IDMA_REG64_1D_DONE_ID_0_OFFSET);
    addr_hit[ 6] = (reg_addr == IDMA_REG64_1D_DONE_ID_1_OFFSET);
    addr_hit[ 7] = (reg_addr == IDMA_REG64_1D_DST_ADDR_LOW_OFFSET);
    addr_hit[ 8] = (reg_addr == IDMA_REG64_1D_DST_ADDR_HIGH_OFFSET);
    addr_hit[ 9] = (reg_addr == IDMA_REG64_1D_SRC_ADDR_LOW_OFFSET);
    addr_hit[10] = (reg_addr == IDMA_REG64_1D_SRC_ADDR_HIGH_OFFSET);
    addr_hit[11] = (reg_addr == IDMA_REG64_1D_LENGTH_LOW_OFFSET);
    addr_hit[12] = (reg_addr == IDMA_REG64_1D_LENGTH_HIGH_OFFSET);
  end
